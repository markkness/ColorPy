...
class TestGammaCorrection(unittest.TestCase):
    ...
    def test_gamma_srgb(self, verbose=False):
        ...
        if verbose:
            print (msg)
        converter = colormodels.GammaConverterSrgb()
    ...
    def test_gamma_power(self, verbose=False):
        ...
        for gamma_value in gamma_set:
            ...
            if verbose:
                print (msg)
            converter = colormodels.GammaConverterPower(gamma=gamma_value)
    ...
    def test_gamma_function(self, verbose=False):
        ...
        converter = colormodels.GammaConverterFunction(
    ...
    def test_srgb_vs_hybrid(self, verbose=True):
        ...
        srgb_converter1 = colormodels.GammaConverterSrgb()
        srgb_converter2 = colormodels.GammaConverterHybrid(
    ...
    def test_srgb_coverage(self, verbose=True):
        ...
        srgb_converter = colormodels.GammaConverterHybrid(
    ...
    def test_color_converter_srgb(self, verbose=True):
        ...
        gamma_converter = colormodels.GammaConverterSrgb()
